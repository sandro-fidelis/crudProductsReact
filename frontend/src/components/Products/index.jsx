...
class FormProduct extends Component {
    ...
    create = () => {
        this.setState({ model: { id: 0, description: '', price: '', quantity: '' } })
        ...
        return (
            <Form>
                <FormGroup>
                    ...
                    <Input id="description" type="text" value={this.state.model.description} placeholder="Descrição do Produto" onChange={e => this.setValues(e, 'description')}>
                    </Input>
                </FormGroup>
                <FormGroup>
                    <div className="form-row">
                        ...
                        <div className="col-md-6">
                            ...
                            <Input id="quantity" type="text" value={this.state.model.quantity} placeholder="Qtd de Produtos" onChange={e => this.setValues(e, 'quantity')}>
                            </Input>
                        </div>
                    </div>
                </FormGroup>
                        ...
                        products.map(product =>
                            <tr key={product.id}>
                                ...
                                <td>
                                    ...
                                    <Button color="danger" size="sm" onClick={e => this.delete(product.id)}>Excluir</Button>
    ...
    delete = (id) => {
        fetch(`${this.Url}/${id}`, { method: 'DELETE' })
            ...
            .then(rows => {
                ...
                this.setState({ products, message: { text: 'Produto excluido com sucesso!', alert: 'danger' } })
                this.timerMessage(3000)
            })
            .catch(e => console.log(e))
    }
